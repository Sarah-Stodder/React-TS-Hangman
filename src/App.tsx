...
const incorrectLeters = guessedLetters.filter(letter => !wordToGuess.includes(letter))
...
{ if (guessedLetters.includes(letter) || isLoser || isWinner) return
  ...
  setGuessedLetters(currentLetters => [...currentLetters, letter])},[guessedLetters,isWinner,isLoser])
